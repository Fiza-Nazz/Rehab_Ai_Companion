...
export default function AuthPage() {
  ...
  useEffect(() => {
    ...
    gsap.timeline({ defaults: { ease: "expo.out" } })
      ...
      .fromTo([field1Ref.current,field2Ref.current,field3Ref.current,checkRef.current],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      alert("Error creating account. Check backend logs.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .cr{ display:flex; align-items:flex-start; gap:0.65rem; }
        .cb{
          width:15px; height:15px; flex-shrink:0; border:1.5px solid var(--border);
          background:#fff; cursor:pointer; display:flex; align-items:center; justify-content:center;
          margin-top:2px; transition:border-color 0.2s,background 0.2s;
        }
        .cb.on{ border-color:var(--amber); background:var(--amber); }
        .cb.on::after{ content:'✓'; color:#fff; font-size:10px; font-weight:700; }
        .cl{ font-size:0.76rem; color:var(--mute); line-height:1.55; cursor:pointer; }
        .cl a{ color:var(--amber); font-weight:500; text-decoration:none; }
      ...
      <div className="root">
        ...
        <div className="card" ref={cardRef}>
          ...
          <div className="left">
            ...
            <p className="form-sub">Fill your personal details to continue</p>

            <form onSubmit={handleSubmit}>
              <div className="fields">
                <div ref={field1Ref} className="field">
                ...
                <div ref={checkRef} className="field">
                  <div className="cr">
                    <div className={`cb${agreed?" on":""}`} onClick={()=>setAgreed(a=>!a)} />
                    <p className="cl" onClick={()=>setAgreed(a=>!a)}>
              ...
              <button ref={btnRef} className="btn" type="submit" disabled={loading||!agreed}>
                {loading
            ...
            <p className="sr">Already have an account? <a href="/login">Sign In</a></p>
          </div>
          ...
          {success && (
            <div className="success-overlay">
              ...
              <p className="st">Welcome aboard.</p>
              <p className="ss">Account created — redirecting…</p>
            </div>
          )}
        </div>
      </div>
